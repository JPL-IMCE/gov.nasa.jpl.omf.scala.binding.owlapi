...
import gov.nasa.jpl.omf.scala.core.IRIScalarRestrictionSignature

import scala.{Int,Option}
import scala.Predef.{require,String}

case class OWLAPIIRIScalarRestrictionSignature
( override val uuid: UUID,
  ...
  extends IRIScalarRestrictionSignature[OWLAPIOMF]
{
  require(null != uuid)
  require(null != name)
  require(null != iri)
