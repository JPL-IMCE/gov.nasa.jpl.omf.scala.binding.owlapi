...
import gov.nasa.jpl.omf.scala.core.EntityScalarDataPropertyQuantifiedRestrictionSignature

import scala.Predef.require

case class OWLAPIEntityScalarDataPropertyQuantifiedRestrictionSignature
( override val uuid: UUID,
  ...
  extends EntityScalarDataPropertyQuantifiedRestrictionSignature[OWLAPIOMF]
{
  require(null != uuid)
