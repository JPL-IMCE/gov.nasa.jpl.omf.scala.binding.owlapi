...
import gov.nasa.jpl.omf.scala.core.NumericScalarRestrictionSignature

import scala.Option
import scala.Predef.{require,String}

case class OWLAPINumericScalarRestrictionSignature
( override val uuid: UUID,
  ...
  extends NumericScalarRestrictionSignature[OWLAPIOMF]
{
  require(null != uuid)
  require(null != name)
  require(null != iri)
