...
object ElementExceptionKind extends Enumeration {
  ...
  EntityCardinalityRestrictedAspect,
  EntityCardinalityRestrictedConcept,
  EntityCardinalityRestrictedReifiedRelationship,
  ...
  DataRelationshipFromStructureToScalar,
  DataRelationshipFromStructureToStructure,
  ScalarDataType,
  StructuredDataType,
