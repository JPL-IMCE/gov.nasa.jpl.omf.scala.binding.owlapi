...
import gov.nasa.jpl.omf.scala.core.StringScalarRestrictionSignature

import scala.{Int,Option}
import scala.Predef.{require,String}

case class OWLAPIStringScalarRestrictionSignature
( override val uuid: UUID,
  ...
  extends StringScalarRestrictionSignature[OWLAPIOMF]
{
  require(null != uuid)
  require(null != name)
  require(null != iri)
