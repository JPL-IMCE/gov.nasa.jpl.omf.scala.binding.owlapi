...
package object terminologies {
  ...
  = TerminologyBoxSignature[OWLAPIOMF, Set](
    ...
    cardinalityRestrictedAspects = Set.empty[CardinalityRestrictedAspect] ++ sig.cardinalityRestrictedAspects,
    concepts = Set.empty[Concept] ++ sig.concepts,
    cardinalityRestrictedConcepts = Set.empty[CardinalityRestrictedConcept] ++ sig.cardinalityRestrictedConcepts,
    ...
    cardinalityRestrictedReifiedRelationships = Set.empty[CardinalityRestrictedReifiedRelationship] ++ sig.cardinalityRestrictedReifiedRelationships,
