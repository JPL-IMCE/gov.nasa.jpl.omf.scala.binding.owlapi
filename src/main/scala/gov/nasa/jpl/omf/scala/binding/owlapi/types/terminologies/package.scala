...
package object terminologies {
  ...
  = TerminologyBoxSignature[OWLAPIOMF, Set](
    ...
    conceptPredicates = Set.empty[ConceptPredicate] ++ sig.conceptPredicates,
    reifiedRelationshipPredicates = Set.empty[ReifiedRelationshipPredicate] ++ sig.reifiedRelationshipPredicates,
    reifiedRelationshipPropertyPredicates = Set.empty[ReifiedRelationshipPropertyPredicate] ++ sig.reifiedRelationshipPropertyPredicates,
    reifiedRelationshipInversePropertyPredicates = Set.empty[ReifiedRelationshipInversePropertyPredicate] ++ sig.reifiedRelationshipInversePropertyPredicates,
    reifiedRelationshipSourcePropertyPredicates = Set.empty[ReifiedRelationshipSourcePropertyPredicate] ++ sig.reifiedRelationshipSourcePropertyPredicates,
    reifiedRelationshipSourceInversePropertyPredicates = Set.empty[ReifiedRelationshipSourceInversePropertyPredicate] ++ sig.reifiedRelationshipSourceInversePropertyPredicates,
    reifiedRelationshipTargetPropertyPredicates = Set.empty[ReifiedRelationshipTargetPropertyPredicate] ++ sig.reifiedRelationshipTargetPropertyPredicates,
    reifiedRelationshipTargetInversePropertyPredicates = Set.empty[ReifiedRelationshipTargetInversePropertyPredicate] ++ sig.reifiedRelationshipTargetInversePropertyPredicates,
    unreifiedRelationshipPropertyPredicates = Set.empty[UnreifiedRelationshipPropertyPredicate] ++ sig.unreifiedRelationshipPropertyPredicates,
    unreifiedRelationshipInversePropertyPredicates = Set.empty[UnreifiedRelationshipInversePropertyPredicate] ++ sig.unreifiedRelationshipInversePropertyPredicates,
