...
object MutableBundle {
  ...
  = MutableBundle(
    sig = TerminologyBoxSignature[OWLAPIOMF, HashSet](
      ...
      conceptPredicates = HashSet.empty[ConceptPredicate],
      reifiedRelationshipPredicates = HashSet.empty[ReifiedRelationshipPredicate],
      reifiedRelationshipPropertyPredicates = HashSet.empty[ReifiedRelationshipPropertyPredicate],
      reifiedRelationshipInversePropertyPredicates = HashSet.empty[ReifiedRelationshipInversePropertyPredicate],
      reifiedRelationshipSourcePropertyPredicates = HashSet.empty[ReifiedRelationshipSourcePropertyPredicate],
      reifiedRelationshipSourceInversePropertyPredicates = HashSet.empty[ReifiedRelationshipSourceInversePropertyPredicate],
      reifiedRelationshipTargetPropertyPredicates = HashSet.empty[ReifiedRelationshipTargetPropertyPredicate],
      reifiedRelationshipTargetInversePropertyPredicates = HashSet.empty[ReifiedRelationshipTargetInversePropertyPredicate],
      unreifiedRelationshipPropertyPredicates = HashSet.empty[UnreifiedRelationshipPropertyPredicate],
      unreifiedRelationshipInversePropertyPredicates = HashSet.empty[UnreifiedRelationshipInversePropertyPredicate],
