...
import gov.nasa.jpl.omf.scala.binding.owlapi.types.terms.RestrictableRelationship
import scala.collection.immutable.Vector

case class InstanceRelationshipEnumerationRestriction
(override val uuid: api.taggedTypes.InstanceRelationshipEnumerationRestrictionUUID,
 restrictedRelationship: RestrictableRelationship,
 domain: ConceptualEntitySingletonInstance,
 references: Vector[ConceptualEntitySingletonInstance])
